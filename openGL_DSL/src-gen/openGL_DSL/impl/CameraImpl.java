...
public class CameraImpl extends MinimalEObjectImpl.Container implements Camera {
	...
	public void setModelViewMat(Object newModelViewMat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.CAMERA__MODEL_VIEW_MAT,
					oldModelViewMat, modelViewMat));
	}
	...
	public void setMProjMat(Object newMProjMat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.CAMERA__MPROJ_MAT, oldMProjMat,
					mProjMat));
	}
	...
	public void setMNearVal(double newMNearVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.CAMERA__MNEAR_VAL, oldMNearVal,
					mNearVal));
	}
	...
	public void setMFarVal(double newMFarVal) {
		...
		mFarVal = newMFarVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.CAMERA__MFAR_VAL, oldMFarVal,
					mFarVal));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OpenGL_DSLPackage.CAMERA__MODEL_VIEW_MAT:
			return MODEL_VIEW_MAT_EDEFAULT == null ? modelViewMat != null
					: !MODEL_VIEW_MAT_EDEFAULT.equals(modelViewMat);
		case OpenGL_DSLPackage.CAMERA__MPROJ_MAT:
