...
public class MaterialImpl extends MinimalEObjectImpl.Container implements Material {
	...
	public void setAmbient(Object newAmbient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MATERIAL__AMBIENT, oldAmbient,
					ambient));
	}
	...
	public void setDifusse(Object newDifusse) {
		...
		difusse = newDifusse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MATERIAL__DIFUSSE, oldDifusse,
					difusse));
	}
	...
	public void setSpecular(Object newSpecular) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MATERIAL__SPECULAR, oldSpecular,
					specular));
	}
