...
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public NotificationChain basicSetLight(Light newLight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					OpenGL_DSLPackage.NODE__LIGHT, oldLight, newLight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLight != light) {
			...
			if (light != null)
				msgs = ((InternalEObject) light).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - OpenGL_DSLPackage.NODE__LIGHT, null, msgs);
			if (newLight != null)
	...
	public EList<Abs_Entity> getAbs_entity() {
		if (abs_entity == null) {
			abs_entity = new EObjectContainmentEList<Abs_Entity>(Abs_Entity.class, this,
					OpenGL_DSLPackage.NODE__ABS_ENTITY);
		}
		return abs_entity;
	}
	...
	public void setPosicion(Object newPosicion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.NODE__POSICION, oldPosicion,
					posicion));
	}
	...
	public void setRotacion(Object newRotacion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.NODE__ROTACION, oldRotacion,
					rotacion));
	}
