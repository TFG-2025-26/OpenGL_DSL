...
public class OpenGL_DSLFactoryImpl extends EFactoryImpl implements OpenGL_DSLFactory {
	...
	public static OpenGL_DSLFactory init() {
		try {
			OpenGL_DSLFactory theOpenGL_DSLFactory = (OpenGL_DSLFactory) EPackage.Registry.INSTANCE
					.getEFactory(OpenGL_DSLPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case OpenGL_DSLPackage.DIR_LIGHT:
			return createDirLight();
		case OpenGL_DSLPackage.POS_LIGHT:
			return createPosLight();
		...
		case OpenGL_DSLPackage.CIRCULO:
			return createCirculo();
		case OpenGL_DSLPackage.RECTANGULO:
			return createRectangulo();
		...
		case OpenGL_DSLPackage.INDEX_MESH:
			return createIndexMesh();
		case OpenGL_DSLPackage.EJES_RGB:
			return createEjesRGB();
		default:
