...
public class SceneManagerImpl extends MinimalEObjectImpl.Container implements SceneManager {
	...
	public void setWinId(int newWinId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__WIN_ID, oldWinId,
					winId));
	}
	...
	public void setWinW(int newWinW) {
		...
		winW = newWinW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__WIN_W, oldWinW,
					winW));
	}
	...
	public void setWinH(int newWinH) {
		...
		winH = newWinH;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__WIN_H, oldWinH,
					winH));
	}
	...
	public NotificationChain basicSetViewport(ViewPort newViewport, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					OpenGL_DSLPackage.SCENE_MANAGER__VIEWPORT, oldViewport, newViewport);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setViewport(ViewPort newViewport) {
		if (newViewport != viewport) {
			...
			if (viewport != null)
				msgs = ((InternalEObject) viewport).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - OpenGL_DSLPackage.SCENE_MANAGER__VIEWPORT, null, msgs);
			if (newViewport != null)
				msgs = ((InternalEObject) newViewport).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - OpenGL_DSLPackage.SCENE_MANAGER__VIEWPORT, null, msgs);
			msgs = basicSetViewport(newViewport, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__VIEWPORT,
	...
	public NotificationChain basicSetCamera(Camera newCamera, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					OpenGL_DSLPackage.SCENE_MANAGER__CAMERA, oldCamera, newCamera);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCamera != camera) {
			...
			if (camera != null)
				msgs = ((InternalEObject) camera).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - OpenGL_DSLPackage.SCENE_MANAGER__CAMERA, null, msgs);
			if (newCamera != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__CAMERA, newCamera,
					newCamera));
	}
	...
	public void setMStop(boolean newMStop) {
		...
		mStop = newMStop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.SCENE_MANAGER__MSTOP, oldMStop,
					mStop));
	}
