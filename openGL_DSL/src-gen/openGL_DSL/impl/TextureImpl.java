...
public class TextureImpl extends MinimalEObjectImpl.Container implements Texture {
	...
	public void setMWidth(int newMWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.TEXTURE__MWIDTH, oldMWidth,
					mWidth));
	}
	...
	public void setMHeight(int newMHeight) {
		...
		mHeight = newMHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.TEXTURE__MHEIGHT, oldMHeight,
					mHeight));
	}
