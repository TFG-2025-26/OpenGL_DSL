...
public class DirLightImpl extends MinimalEObjectImpl.Container implements DirLight {
	...
	public void setAmbient(Object newAmbient) {
		...
		ambient = newAmbient;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.DIR_LIGHT__AMBIENT, oldAmbient, ambient));
	}
	...
	public void setDifusse(Object newDifusse) {
		...
		difusse = newDifusse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.DIR_LIGHT__DIFUSSE, oldDifusse, difusse));
	}
	...
	public void setSpecular(Object newSpecular) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.DIR_LIGHT__SPECULAR, oldSpecular, specular));
	}
