...
public class IndexMeshImpl extends MeshImpl implements IndexMesh {
	...
	public void setVIndices(Object newVIndices) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.INDEX_MESH__VINDICES, oldVIndices, vIndices));
	}
	...
	public void setNNumIndices(Object newNNumIndices) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.INDEX_MESH__NNUM_INDICES, oldNNumIndices, nNumIndices));
	}
