...
public class MeshImpl extends MinimalEObjectImpl.Container implements Mesh {
	...
	public void setMPrimitive(Object newMPrimitive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__MPRIMITIVE, oldMPrimitive, mPrimitive));
	}
	...
	public void setNNumVertices(Object newNNumVertices) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__NNUM_VERTICES, oldNNumVertices, nNumVertices));
	}
	...
	public void setVColors(Object newVColors) {
		...
		vColors = newVColors;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__VCOLORS, oldVColors, vColors));
	}
	...
	public void setVVertices(Object newVVertices) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__VVERTICES, oldVVertices, vVertices));
	}
	...
	public void setVTexCoords(Object newVTexCoords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__VTEX_COORDS, oldVTexCoords, vTexCoords));
	}
	...
	public void setVNormals(Object newVNormals) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.MESH__VNORMALS, oldVNormals, vNormals));
	}
