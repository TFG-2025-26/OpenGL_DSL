...
public class PosLightImpl extends MinimalEObjectImpl.Container implements PosLight {
	...
	public void setAmbient(Object newAmbient) {
		...
		ambient = newAmbient;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.POS_LIGHT__AMBIENT, oldAmbient, ambient));
	}
	...
	public void setDifusse(Object newDifusse) {
		...
		difusse = newDifusse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.POS_LIGHT__DIFUSSE, oldDifusse, difusse));
	}
	...
	public void setSpecular(Object newSpecular) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.POS_LIGHT__SPECULAR, oldSpecular, specular));
	}
	...
	public void setPosDIr(Object newPosDIr) {
		...
		posDIr = newPosDIr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenGL_DSLPackage.POS_LIGHT__POS_DIR, oldPosDIr, posDIr));
	}
