...
public class OpenGL_DSLSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OpenGL_DSLPackage.DIR_LIGHT: {
				...
				if (result == null) result = caseLight(dirLight);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenGL_DSLPackage.POS_LIGHT: {
				...
				if (result == null) result = caseLight(posLight);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenGL_DSLPackage.SPOT_LIGHT: {
				...
				if (result == null) result = casePosLight(spotLight);
			...
			case OpenGL_DSLPackage.QUADRIC_ENTITY: {
				...
				if (result == null) result = caseAbs_Entity(quadricEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case OpenGL_DSLPackage.MB_R: {
				...
				if (result == null) result = caseIndexMesh(mbR);
				if (result == null) result = caseMesh(mbR);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case OpenGL_DSLPackage.INDEX_MESH: {
				...
				if (result == null) result = caseMesh(indexMesh);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenGL_DSLPackage.EJES_RGB: {
				EjesRGB ejesRGB = (EjesRGB)theEObject;
				T result = caseEjesRGB(ejesRGB);
				if (result == null) result = caseAbs_Entity(ejesRGB);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ejes RGB</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ejes RGB</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
